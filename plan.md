...
> 当前状态：**P0 五个核心模块已完成并通过验收（2026-08-16）**；**P1 学习模块已精简为笔记导入 + 只读 Markdown 阅读（2026-08-18）**；**P2 计划页增强（过往周浏览 + 统计 + 周总结）已完成（2026-08-28）**；**#26/#27 阅读弹窗大纲样式调整已完成（2026-08-29）**；**#34 笔记导入标题去重已完成（2026-08-29）**。
